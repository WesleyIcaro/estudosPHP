...
<body>
    <main>
        ...
        // $minimos = intdiv($salario, 1412);
        // $minimos = (int) ($salario / 1412);
        ...
        <form action="<?= $_SERVER['PHP_SELF'] ?>" method="get">
            ...
            <p>Considerando o salário minímo de <strong>R$ 1.412,00</strong></p>
            <!-- <p>Considerando o salário minímo de R$ <?= number_format($minimo, 2, ",", ".") ?></p> -->
